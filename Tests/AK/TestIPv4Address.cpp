...
{
    auto constexpr addr = IPv4Address::from_string("192.168.0.1"sv);
...
{
    auto constexpr addr = IPv4Address::from_string("bad string"sv);
...
{
    auto constexpr addr = IPv4Address::from_string("192.168.0.500"sv);
...
{
    auto constexpr addr = IPv4Address::from_string("1"sv);
...
{
    auto constexpr addr = IPv4Address::from_string("192.1"sv);
...
{
    auto constexpr addr = IPv4Address::from_string("192.168.1"sv);
